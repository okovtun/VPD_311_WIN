...
4. Должна быть возможность добавлять, удалять и изменять будильники;
5. Будильники должны звонить в свое время;
6. Часы должны перемещаться мышкой даже когда не видны элементы управления;
